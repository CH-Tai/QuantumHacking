...
try:
    open(str(Path(__file__).parent.absolute())+f"/results/time/updatetime.png", "x").close()
except:
    pass
...
plt.savefig(str(Path(__file__).parent.absolute())+f"/results/time/updatetime.png")
plt.clf()
